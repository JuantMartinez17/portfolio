...
const translations = {
  es: {
    ...
    "about.p1": "Soy Técnico Universitario en Programación de Sistemas y disfruto genuinamente del oficio de construir software. La mayoría de mi trabajo vive en la intersección entre web y mobile — apps fullstack con React y Node, Android nativo con Kotlin, y alguna que otra inmersión en desarrollo de juegos con Godot.",
